...
public class HomePage extends BasePage {
	...
	public HomePage HealthQueue(String ExpTag) {
			...
			Assert.assertEquals(versionNum.contains(ExpTag), true);
			ui_wait(3);
			ui_IsElementDisplay(ui_waitForElementToDisplay(jobExecutionhistoryMainHeading, Pause.MEDIUM));
